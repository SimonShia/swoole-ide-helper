 ...
 * @return int
 */
function swoole_client_select(array &$read, array &$write, array &$error, $timeout=0.1)
{
}
 ...
 * @param float $timeout
 */
function swoole_select(array &$read, array &$write, array &$error, $timeout=0.1)
{
